...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { date: @weight.date, notes: @weight.notes, score: @weight.score, user_id: @weight.user_id } }
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { date: @weight.date, notes: @weight.notes, score: @weight.score, user_id: @weight.user_id } }
